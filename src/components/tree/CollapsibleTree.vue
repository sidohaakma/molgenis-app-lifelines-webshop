  ...
  <div id="tree-view">
    <ul class="list-group">
      <template v-for="parent in structure">
        <li
          :key="parent.name"
          class="list-group-item list-group-item-outline-secondary list-group-item-action text-truncate pr-3"
          :title="parent.name"
          role="button"
          ...
          <li class="list-group-item p-0" v-if="parent.name in collapsed && parent.children && parent.children.length > 0">
            <ul class="list-group list-group-flush">
              <li
                ...
                class="list-group-item list-group-item-outline-secondary list-group-item-action px-3 py-1"
                role="button"
